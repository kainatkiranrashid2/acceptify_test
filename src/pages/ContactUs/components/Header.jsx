...
const Header = () => {
  ...
  return (
    <section className=" relative overflow-hidden dark:bg-[#06142F]">
      ...
      <div className="absolute  hidden lg:block dark:hidden top-10 contact__leftoval opacity-15 md:opacity-20 -left-[40%] md:-left-[20%] z-0 "></div>
      <div className="absolute dark:hidden hidden sm:block sm:top-[620px] md:top-[650px] lg:top-[550px] contact__rightoval opacity-10 dark:opacity-5 -right-[20%] z-0 "></div>
