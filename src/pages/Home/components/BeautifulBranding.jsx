      ...
      <div className=" flex flex-col items-center justify-between ">
        <div className="xl:w-3/5 xl:max-w-3/5 flex  flex-col items-center justify-between">
          ...
          <p className="w-full ">
            ...
            represent your business. Incorporating your brand’s colors, logo and
            design elements, the payment device reinforces brand recognition and
            transforms each transaction into a brand touchpoint.
          </p>
        </div>
