      ...
      <div className="relative h-full aspect-video">
        ...
        <div className="ml-5 lg:ml-20  relative z-10 h-full flex items-center">
          <div className="max-w-[300px] lg:max-w-[430px]">
            ...
            <button className="bg-primary text-[16px] tracking-tight leading-6  flex flex-row justify-center items-center gap-3 text-white  font-semibold px-3 py-[10px] rounded-lg  ">
              Start Now{" "}
              <img
