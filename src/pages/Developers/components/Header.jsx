...
paymentEngine.StartTransaction(transaction, (transactionResult, transactionResponse) => { ... });`;
  ...
  return (
    <section
      className="flex flex-col justify-center items-center 2xl:h-[1100px] xl:h-[1100px] lg:h-[800px] w-full  bg-cover bg-center relative bg-no-repeat py-16 md:py-20 bg-[url(https://res.cloudinary.com/dq5guzzge/image/upload/v1735800494/components/developers_header/bg_light.png)]
